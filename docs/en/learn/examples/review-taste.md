...
> `learn/knowledge/review-taste.md` and starts empty until agents enrich it during real
> work. Agents never read, cite, or write under `docs/en/learn/examples/` — this tree is
> for human readers only. See [ADR-003 §5](../adr/003-learning-mode-relocate-and-rename.md)
> for the design rationale.

> This file's home in the knowledge pillar is `learn/knowledge/review-taste.md`.
