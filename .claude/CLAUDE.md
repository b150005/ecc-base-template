...
| 14 | Research-tier validation for auth→T2 mis-classifications | ◐ in-progress | spec: `specs/14-research-tier-validation.md`<br>adr: `.claude/meta/adr/021-research-tier-auth-validation.md` |
