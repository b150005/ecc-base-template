...
The domain declaration lives in a prompt-body `## Learning Domains` section (not a
frontmatter key). The feature is named "Learning Mode" and the knowledge output
directory is `.claude/learn/knowledge/`.
