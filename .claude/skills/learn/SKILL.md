...
name: learn
description: >
  Toggle Developer Learning Mode and manage per-domain focus for the living knowledge base at
  learn/knowledge/. Learning Mode is a default-off learning layer that instructs every
  learning-aware agent to contribute teaching moments to a domain-organized knowledge base as
  ...
  Supported invocations:
    ...
    /learn status                   — Print current config and last-ten knowledge-diff summaries
