...
weighed deliberately: CLAUDE.md becomes write-quiet across worktrees
in exchange for the loss of Invariant-2 auto-load on the Roadmap. The
Invariant 2 **statement** is unchanged; what changed is which content
is now governed by it.
