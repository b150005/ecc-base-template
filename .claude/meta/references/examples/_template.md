...
> `.claude/learn/knowledge/<domain>.md` and starts empty until agents enrich it during real work.
> Agents never read, cite, or write under `.claude/meta/references/examples/` — this tree is for
