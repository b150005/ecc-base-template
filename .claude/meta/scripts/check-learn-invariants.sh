...
# tests that get disabled. This script checks structural invariants instead:
# the presence and shape of the Learning Mode contract blocks, not the
# semantic content of any single agent response.
#
# Checks:
