...
This template uses sibling filenames for bilingual docs:
...
When a workaround flips to `status: resolved`, update the CHANGELOG
using `user_impact` per Keep a Changelog 1.1.0:
